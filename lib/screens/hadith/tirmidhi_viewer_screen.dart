...
class TirmidhiViewerScreen extends StatefulWidget {
  final int volumeNumber;

  const TirmidhiViewerScreen({
    super.key,
    required this.volumeNumber,
  });

  @override
  State<TirmidhiViewerScreen> createState() => _TirmidhiViewerScreenState();
}

class _TirmidhiViewerScreenState extends State<TirmidhiViewerScreen> {
  late final PageController _pageController;
  int _currentPage = 0;
  late final int _totalPages;
  late final int _startPage;

  // Page counts per volume (split 962 pages into 10 parts)
  ...
  String _getPageImageUrl(int pageIndex) {
    ...
    return 'https://iiif.archive.org/image/iiif/3/'
        'sunan-tirmidhi%2FSunan%20Tirmidhi_jp2.zip%2FSunan%20Tirmidhi_jp2%2FSunan%20Tirmidhi_$paddedPage.jp2'
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          '${context.tr('jami_tirmidhi')} - ${context.tr('volume')} ${widget.volumeNumber}',
