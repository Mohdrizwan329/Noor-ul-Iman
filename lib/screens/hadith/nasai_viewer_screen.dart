...
class NasaiViewerScreen extends StatefulWidget {
  final int volumeNumber;

  const NasaiViewerScreen({
    super.key,
    required this.volumeNumber,
  });

  @override
  State<NasaiViewerScreen> createState() => _NasaiViewerScreenState();
}

class _NasaiViewerScreenState extends State<NasaiViewerScreen> {
  late final PageController _pageController;
  int _currentPage = 0;
  late final int _totalPages;
  late final int _startPage;

  // Page counts per volume (split 992 pages into 10 parts)
  ...
  String _getPageImageUrl(int pageIndex) {
    ...
    return 'https://iiif.archive.org/image/iiif/3/'
        'sunan-nasai_202202%2FSunan%20Nasai_jp2.zip%2FSunan%20Nasai_jp2%2FSunan%20Nasai_$paddedPage.jp2'
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          '${context.tr('sunan_nasai')} - ${context.tr('volume')} ${widget.volumeNumber}',
