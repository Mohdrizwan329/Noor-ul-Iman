...
class MuslimViewerScreen extends StatefulWidget {
  final int volumeNumber;

  const MuslimViewerScreen({
    super.key,
    required this.volumeNumber,
  });

  @override
  State<MuslimViewerScreen> createState() => _MuslimViewerScreenState();
}

class _MuslimViewerScreenState extends State<MuslimViewerScreen> {
  late final PageController _pageController;
  int _currentPage = 0;
  late final int _totalPages;
  late final int _startPage;

  // Page counts per volume (split 4513 pages into 10 parts)
  static const List<int> _volumePageCounts = [
    452, 452, 451, 451, 451, 451, 451, 451, 451, 452,
  ];
  ...
  String _getPageImageUrl(int pageIndex) {
    ...
    return 'https://iiif.archive.org/image/iiif/3/'
        'sahih-muslim-arabic%2Fsahih-muslim-arabic_jp2.zip%2Fsahih-muslim-arabic_jp2%2Fsahih-muslim-arabic_$paddedPage.jp2'
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          '${context.tr('sahih_muslim')} - ${context.tr('volume')} ${widget.volumeNumber}',
