...
class _NamazGuideScreenState extends State<NamazGuideScreen> {
  ...
  final List<Map<String, dynamic>> _namazCategories = [
    {
      'titleKey': 'namaz_guide_1_fajr_prayer',
      'title': 'Fajr Prayer',
      'titleUrdu': 'نماز فجر',
      ...
      'rakatsArabic': '٢ سنة + ٢ فرض = ٤ ركعات',
...
**الوقت:** من طلوع الفجر (عند ظهور أول ضوء في الأفق) حتى قبل شروق الشمس مباشرة.
...
**ركعتا السنة:**
١. النية لصلاة ركعتي السنة للفجر
٢. رفع اليدين إلى الأذنين مع قول "الله أكبر"
٣. قراءة الثناء والتعوذ والبسملة
٤. قراءة سورة الفاتحة
٥. قراءة سورة (مثل سورة الإخلاص)
٦. الركوع مع قول "الله أكبر"
٧. قول "سبحان ربي العظيم" (3 مرات)
٨. الرفع من الركوع مع قول "سمع الله لمن حمده"
٩. قول "ربنا لك الحمد"
١٠. السجود مع قول "الله أكبر"
١١. قول "سبحان ربي الأعلى" (3 مرات)
١٢. الجلوس مع قول "الله أكبر"
١٣. السجدة الثانية بنفس الطريقة
١٤. القيام للركعة الثانية
١٥. تكرار الخطوات 4-13
١٦. الجلوس للتشهد (التحيات)
١٧. قراءة الصلاة الإبراهيمية
١٨. قراءة الدعاء
١٩. التسليم يميناً ثم يساراً "السلام عليكم ورحمة الله"

**ركعتا الفرض:**
نفس الطريقة مع النية لفرض الفجر.

**الفضائل:**
• ركعتا سنة الفجر خير من الدنيا وما فيها (صحيح مسلم)
• تشهدها ملائكة الليل والنهار
• الحماية من النار لمن صلى الفجر والعصر''',
      },
    },
    {
      'titleKey': 'namaz_guide_2_zuhr_prayer',
      'title': 'Zuhr Prayer',
      'titleUrdu': 'نماز ظہر',
      ...
      'rakatsArabic': '٤ سنة + ٤ فرض + ٢ سنة + ٢ نفل = ١٢ ركعة',
...
**الوقت:** من بعد زوال الشمس (منتصف النهار) حتى يصير ظل الشيء مثله بالإضافة إلى ظل الزوال.

**الركعات:**
• 4 ركعات سنة مؤكدة (قبل الفرض)
• 4 ركعات فرض
• 2 ركعة سنة مؤكدة (بعد الفرض)
• 2 ركعة نافلة (اختيارية)
• المجموع: 12 ركعة

**كيفية صلاة 4 ركعات:**

1. النية للصلاة
2. أول ركعتين مثل صلاة الفجر
3. بعد السجدة الثانية من الركعة الثانية، الجلوس للتشهد
4. قراءة التحيات فقط، ثم القيام
5. في الركعة الثالثة والرابعة، قراءة سورة الفاتحة فقط
6. بعد سجدة الركعة الرابعة، الجلوس للتشهد الأخير
7. قراءة التحيات والصلاة الإبراهيمية والدعاء
8. التسليم إلى الجانبين

**ملاحظة خاصة للفرض:**
• في الركعة الثالثة والرابعة من الفرض، تقرأ سورة الفاتحة فقط
• لا تقرأ سورة إضافية بعد الفاتحة في هذه الركعات

**الفضائل:**
• لم يترك النبي ﷺ الأربع ركعات السنة قبل الظهر أبداً
• من صلى 12 ركعة في اليوم (بما فيها سنة الظهر)، بنى الله له بيتاً في الجنة''',
      },
    },
    {
      'titleKey': 'namaz_guide_3_asr_prayer',
      'title': 'Asr Prayer',
      'titleUrdu': 'نماز عصر',
      ...
      'rakatsArabic': '٤ سنة غير مؤكدة + ٤ فرض = ٨ ركعات',
...
**الوقت:** من عندما يصبح ظل الشيء مثله (بالإضافة إلى ظل الزوال) حتى غروب الشمس.

**الركعات:**
• 4 ركعات سنة غير مؤكدة (اختيارية، قبل الفرض)
• 4 ركعات فرض
• المجموع: 8 ركعات (الحد الأدنى 4 فرض)

**كيفية الصلاة:**
نفس طريقة صلاة الظهر 4 ركعات.

**نقاط مهمة:**
• يكره الصلاة عندما تصفر الشمس (15-20 دقيقة قبل الغروب)
• ولكن إذا فاتت صلاة العصر، يجب أداؤها حتى في ذلك الوقت
• تحذير شديد لمن ترك صلاة العصر عمداً

**الفضائل:**
• قال النبي ﷺ: "من صلى الفجر والعصر دخل الجنة" (صحيح البخاري)
• "من فاتته صلاة العصر، فكأنما وتر أهله وماله" (صحيح البخاري)
• الصلاة الوسطى المذكورة في القرآن تشير إلى صلاة العصر عند كثير من العلماء''',
      },
    },
    {
      'titleKey': 'namaz_guide_4_maghrib_prayer',
      ...
      'rakatsArabic': '٣ فرض + ٢ سنة + ٢ نفل = ٧ ركعات',
...
**الوقت:** من غروب الشمس حتى يغيب الشفق الأحمر (حوالي 1-1.5 ساعة بعد الغروب).
...
**كيفية صلاة 3 ركعات فرض:**

1. النية لثلاث ركعات فرض المغرب
2. أول ركعتين مثل الفجر مع القراءة الجهرية
3. بعد السجدة الثانية، الجلوس للتشهد
4. قراءة التحيات فقط، ثم القيام
5. في الركعة الثالثة، قراءة سورة الفاتحة فقط (سراً)
6. إتمام الركوع والسجود
7. الجلوس للتشهد الأخير
8. قراءة التحيات والصلاة الإبراهيمية والدعاء
9. التسليم

**ملاحظات خاصة:**
• الإمام يقرأ جهراً في أول ركعتين
• الركعة الثالثة تقرأ سراً
• لا ينبغي تأخير صلاة المغرب بلا سبب

**الفضائل:**
• أول صلاة بعد انتهاء صوم اليوم
• نصح النبي ﷺ بالمبادرة إلى صلاة المغرب
• ثواب الصلاة في المسجد 27 ضعفاً''',
      },
    },
    {
      'titleKey': 'namaz_guide_5_isha_prayer',
      'title': 'Isha Prayer',
      'titleUrdu': 'نماز عشاء',
      'titleHindi': 'इशा की नमाज़',
      'titleArabic': 'صلاة العشاء',
      'rakats':
          '4 Sunnah + 4 Fard + 2 Sunnah + 2 Nafl + 3 Witr + 2 Nafl = 17 Rakats',
      'rakatsUrdu': '۴ سنت + ۴ فرض + ۲ سنت + ۲ نفل + ۳ وتر + ۲ نفل = ۱۷ رکعت',
      'rakatsHindi':
          '4 सुन्नत + 4 फ़र्ज़ + 2 सुन्नत + 2 नफ़्ल + 3 वित्र + 2 नफ़्ल = 17 रकात',

      'rakatsArabic': '٤ سنة + ٤ فرض + ٢ سنة + ٢ نفل + ٣ وتر + ٢ نفل = ١٧ ركعة',
...
**الوقت:** من بعد غياب الشفق حتى منتصف الليل (يمكن الصلاة حتى الفجر عند الضرورة).

**الركعات:**
• 4 ركعات سنة غير مؤكدة (قبل الفرض)
• 4 ركعات فرض
• 2 ركعة سنة مؤكدة (بعد الفرض)
• 2 ركعة نافلة (اختيارية)
• 3 ركعات وتر (واجبة)
...
**كيفية صلاة الوتر (3 ركعات):**

1. النية لثلاث ركعات الوتر
2. صلاة ركعتين مثل الفجر
3. القيام للركعة الثالثة
4. قراءة الفاتحة وسورة
5. قبل الركوع، رفع اليدين وقراءة دعاء القنوت
6. ثم إتمام الصلاة بالطريقة العادية

**دعاء القنوت:**
"اللهم إنا نستعينك ونستغفرك ونؤمن بك ونتوكل عليك ونثني عليك الخير ونشكرك ولا نكفرك ونخلع ونترك من يفجرك. اللهم إياك نعبد ولك نصلي ونسجد وإليك نسعى ونحفد ونرجو رحمتك ونخشى عذابك إن عذابك بالكفار ملحق"

**الفضائل:**
• صلاة العشاء في جماعة تعدل نصف الليل في الصلاة
• أكد النبي ﷺ على صلاة الوتر بشدة
• أفضل وقت للوتر هو الثلث الأخير من الليل''',
      },
    },
    {
      'titleKey': 'namaz_guide_6_jumua_prayer',
      ...
      'rakatsHindi':
          '4 सुन्नत + 2 फ़र्ज़ + 4 सुन्नत + 2 सुन्नत + 2 नफ़्ल = 14 रकात',

      'rakatsArabic': '٤ سنة + ٢ فرض + ٤ سنة + ٢ سنة + ٢ نفل = ١٤ ركعة',
...
**الوقت:** في وقت الظهر يوم الجمعة. تحل محل صلاة الظهر.

**الركعات:**
• 4 ركعات سنة (قبل الخطبة)
• الخطبة - جزءان
• 2 ركعة فرض (خلف الإمام)
• 4 ركعات سنة (بعد الفرض)
• 2 ركعة سنة
• 2 ركعة نافلة
• المجموع: 14 ركعة

**ترتيب صلاة الجمعة:**
1. صلاة 4 ركعات سنة عند الوصول
2. الاستماع إلى الخطبة بصمت
3. صلاة ركعتي الفرض خلف الإمام
4. صلاة 4 ركعات سنة بعدها
5. ثم ركعتا السنة وركعتا النافلة

**الأحكام:**
• واجبة على الرجال المسلمين البالغين
• يجب أداؤها في جماعة
• لا يمكن صلاتها منفرداً
• المعذورون: المسافرون، المرضى، النساء (اختيارية لهن)
• الغسل يوم الجمعة مستحب بشدة

**الفضائل:**
• أفضل يوم في الأسبوع
• ساعة خاصة لإجابة الدعاء
• الملائكة تسجل من يأتي مبكراً
• الجمعة سيدة الأيام
• قال النبي ﷺ: "من ترك ثلاث جمع متواليات، طبع الله على قلبه"''',
      },
    },
    {
      'titleKey': 'namaz_guide_7_eid_prayer',
      'title': 'Eid Prayer',
      'titleUrdu': 'نماز عید',
      ...
      'rakatsArabic': 'ركعتان مع ٦ تكبيرات إضافية',
...
**الوقت:** بعد شروق الشمس (حوالي 15-20 دقيقة بعدها) حتى قبل الزوال (منتصف النهار).

**عيد الفطر:** 1 شوال (بعد رمضان)
**عيد الأضحى:** 10 ذو الحجة

**الركعات:** ركعتان مع تكبيرات زائدة

**كيفية الصلاة (المذهب الحنفي):**

**الركعة الأولى:**
1. النية وتكبيرة الإحرام
2. قراءة الثناء
3. ثلاث تكبيرات زائدة، مع رفع اليدين في كل مرة
4. بعد التكبيرة الثالثة، وضع اليدين
5. الإمام يقرأ الفاتحة وسورة
6. إتمام الركوع والسجود بالطريقة العادية

**الركعة الثانية:**
1. الإمام يقرأ الفاتحة وسورة
2. ثلاث تكبيرات زائدة (مع رفع اليدين)
3. التكبيرة الرابعة والذهاب إلى الركوع
4. إتمام الصلاة بالطريقة العادية
5. بعد السلام، الاستماع إلى الخطبة

**نقاط مهمة:**
• سنة مؤكدة عند البعض، واجبة عند آخرين
• لا أذان ولا إقامة
• الخطبة بعد الصلاة (عكس الجمعة)
• الاستماع إلى الخطبة واجب
• تكبير العيد: "الله أكبر الله أكبر لا إله إلا الله، الله أكبر الله أكبر ولله الحمد"

**خاص بعيد الفطر:**
• تناول شيء حلو قبل الذهاب
• دفع زكاة الفطر قبل الصلاة

**خاص بعيد الأضحى:**
• عدم الأكل قبل الصلاة
• تقديم الأضحية بعد الصلاة
• تكبيرات التشريق من فجر 9 ذي الحجة إلى عصر 13 ذي الحجة''',
      },
    },
    {
      'titleKey': 'namaz_guide_8_janazah_prayer',
      ...
      'rakatsArabic': '4 तकबीरात, रुकू सुजूद नहीं',
...
**الحكم:** فرض كفاية (واجب جماعي)

**الوقت:** يمكن أداؤها في أي وقت عدا أوقات شروق الشمس وغروبها وعند استواء الشمس في وسط السماء.

**موضع الوقوف:**
• للرجل: يقف بمحاذاة الصدر
• للمرأة: يقف بمحاذاة الوسط
• للطفل: يقف بمحاذاة الرأس

**كيفية الصلاة:**

**بعد التكبيرة الأولى:**
• وضع اليدين وقراءة الثناء (سبحانك...)
...
(اللهم اغفر لأحيائنا وأمواتنا، الحاضرين والغائبين، الصغار والكبار، الذكور والإناث. اللهم من أبقيته حياً منا، فأبقه على الإسلام، ومن توفيته منا، فتوفه على الإيمان.)

**للطفل الذي لم يبلغ، تضاف:**
"اللهم اجعله لنا فرطاً واجعله لنا أجراً وذخراً واجعله لنا شافعاً ومشفعاً"
...
**نقاط مهمة:**
• لا ركوع ولا سجود
• الإمام يقف أمام الجنازة
• الصفوف يجب أن تكون فردية (3، 5، 7...)
• يجب خلع الأحذية
• التوجه نحو القبلة
• يجب أن يكون رأس الميت إلى يمين الإمام''',
      },
    },
    {
      'titleKey': 'namaz_guide_9_tahajjud_prayer',
      ...
      'rakatsArabic': '2-12 रकात (जोड़ों में)',
...
**الوقت:** بعد النوم ليلاً، ثم الاستيقاظ للصلاة قبل الفجر. أفضل وقت هو الثلث الأخير من الليل.

**الركعات:** الحد الأدنى 2، والحد الأقصى حسب الاستطاعة. عادة تصلى على شكل أزواج من ركعتين.

**كيفية الصلاة:**
1. الاستيقاظ بعد النوم
2. الوضوء
3. صلاة ركعتين في كل مرة
4. يمكن صلاة 2، 4، 6، 8، 10، أو 12 ركعة
5. الختم بالوتر إذا لم يصل بعد العشاء

**السور الموصى بها:**
• السور الطويلة لمن حفظها
• سورة الملك، السجدة، المزمل موصى بها

**الفضائل:**
• ينزل الله إلى السماء الدنيا في الثلث الأخير من الليل
• يقول النبي ﷺ: يسأل الله "هل من سائل؟" ويستجيب
• أقرب العبد إلى ربه هو من يصلي بالليل
• كان النبي ﷺ يصلي حتى تتورم قدماه

**الدعاء الخاص عند الاستيقاظ:**
...
ثم سل الله ما تشاء، وتوضأ، وصل.

**نصائح:**
• ضع المنبه للثلث الأخير من الليل
• نم مبكراً بعد العشاء
• اعقد النية قبل النوم
• ابدأ بكمية قليلة وزدها تدريجياً''',
      },
    },
    {
      'titleKey': 'namaz_guide_10_ishraq_prayer',
      'title': 'Ishraq Prayer',
      'titleUrdu': 'نماز اشراق',
      'titleHindi': 'इशराक़ की नमाज़',
      'titleArabic': 'صلاة الإشراق',
      'rakats': '2-4 Rakats',
      'rakatsUrdu': '۲-۴ رکعت',
      'rakatsHindi': '2-4 रकात',

      'rakatsArabic': '2-4 रकात',
...
**الوقت:** بعد 15-20 دقيقة من شروق الشمس (عندما ترتفع الشمس بمقدار رمح).

**الركعات:** الحد الأدنى 2، يمكن حتى 8 ركعات (ركعتان في كل مرة)

**كيفية الصلاة:**
1. الجلوس في المصلى بعد صلاة الفجر
2. الانتظار حتى تشرق الشمس وترتفع
3. صلاة ركعتين على الأقل (يمكن المزيد)
4. نفس طريقة صلاة النافلة

**الفضائل:**
• تساوي ثواب حجة وعمرة كاملة تامة تامة (حديث صحيح)
• من صلى الفجر في جماعة ثم جلس يذكر الله حتى الإشراق، ثم صلى ركعتين، كان له أجر حجة وعمرة
• صلاة الأوابين (التوابين)
• وقت مبارك للعبادة

**ملاحظات:**
• تسمى أيضاً صلاة الضحى المبكرة
• يفضل أداؤها بعد الجلوس في المصلى منذ الفجر
• من أفضل العبادات بعد الفرائض
• يمكن صلاتها في المنزل أيضاً

**نصيحة للأجر الكامل:**
صل الفجر في المسجد، ثم اجلس تذكر الله وتقرأ القرآن حتى تشرق الشمس وترتفع، ثم صل ركعتين. هكذا تحصل على ثواب حجة وعمرة تامة.''',
      },
    },
    {
      'titleKey': 'namaz_guide_11_duhachasht_prayer',
...
• दिन में बरकत लाती है''',
        'arabic': '''**صلاة الضحى (الإشراق))**

**الوقت:** من بعد ارتفاع الشمس (حوالي 15-20 دقيقة بعد الشروق) حتى قبل الزوال (قبل صلاة الظهر بحوالي 10-15 دقيقة).

**الوقت الأفضل:** عندما تشتد حرارة الشمس (منتصف الوقت بين الشروق والظهر)
...
**كيفية الصلاة:**
1. النية لصلاة الضحى
2. صلاة ركعتين مثل النافلة
3. يمكن تكرار ذلك حتى 12 ركعة
4. قراءة أي سورة بعد الفاتحة

**السور الموصى بها:**
• سورة الشمس (والشمس وضحاها)
• سورة الضحى
• أو أي سورة قصيرة

**الفضائل:**
• صلاها النبي ﷺ وأوصى بها أبا هريرة وأبا الدرداء
• "في كل سلامى من أحدكم صدقة... ويجزئ عن ذلك ركعتان يركعهما من الضحى" (صحيح مسلم)
• من حافظ عليها، غفرت ذنوبه ولو كانت مثل زبد البحر
• صلاة الأوابين (العائدين إلى الله)

**فوائد:**
• تكفي عن 360 صدقة عن كل مفصل في الجسم
• تملأ النهار بالبركة
• تقوي العبد روحياً
• من أحب العبادات إلى الله

**ملاحظة:**
صلاة الإشراق (بعد الشروق مباشرة) وصلاة الضحى (في منتصف الوقت) كلاهما نفس الصلاة، لكن الوقت مختلف والفضل يزيد في وقت اشتداد الحرارة.''',
      },
    },
    {
      'titleKey': 'namaz_guide_12_awwabin_prayer',
      'title': 'Awwabin Prayer',
      'titleUrdu': 'نماز اوابین',
      'titleHindi': 'अव्वाबीन की नमाज़',
      'titleArabic': 'صلاة الأوابين',
      'rakats': '6-20 Rakats',
      'rakatsUrdu': '۶-۲۰ رکعت',
      'rakatsHindi': '6-20 रकात',

      'rakatsArabic': '6-20 रकात',
...
**الركعات:** 6 ركعات (ركعتان ركعتان)

**كيفية الصلاة:**
1. بعد صلاة سنة المغرب (ركعتان)
2. صلاة 6 ركعات إضافية
3. تصلى ركعتين ركعتين
4. يمكن صلاتها منفصلة أو متصلة

**الطريقة:**
• صل ركعتي السنة المؤكدة أولاً
• ثم صل 6 ركعات أخرى (3 مرات × 2 ركعة)
• أو يمكن اعتبار السنة والنوافل معاً ضمن الأوابين

**الفضائل:**
• عن أبي هريرة رضي الله عنه: "من صلى بعد المغرب ست ركعات، لم يتكلم فيما بينهن بسوء، عدلن له بعبادة اثنتي عشرة سنة"
• صلاة الأوابين (التوابين الراجعين إلى الله)
• ثواب عظيم لصلاة قصيرة
• تمحو الذنوب والخطايا

**معنى الأوابين:**
الأوابون هم الراجعون إلى الله التائبون، والعائدون إليه بكثرة. سميت بهذا الاسم لأنها صلاة التوابين المخبتين.

**ملاحظات:**
• وقت قصير بين المغرب والعشاء
• استغلال هذا الوقت بالعبادة مستحب
• يمكن صلاتها في المسجد أو البيت
• الأفضل عدم التأخير بعد المغرب

**نصيحة:**
استعجل في صلاة المغرب، ثم صل السنة والأوابين، واستفد من هذا الوقت المبارك. فالوقت قصير والثواب عظيم.''',
      },
    },
    {
      'titleKey': 'namaz_guide_13_tasbeeh_prayer',
      'title': 'Tasbeeh Prayer',
      'titleUrdu': 'نماز تسبیح',
      'titleHindi': 'तस्बीह की नमाज़',
      'titleArabic': 'صلاة التسبيح',
      'rakats': '4 Rakats with 300 Tasbeeh',
      'rakatsUrdu': '۴ رکعت ۳۰۰ تسبیح کے ساتھ',
      'rakatsHindi': '4 रकात 300 तस्बीह के साथ',

      'rakatsArabic': '4 रकात 300 तस्बीह के साथ',
...
**الوقت:** يمكن أداؤها في أي وقت تجوز فيه النافلة.

**الركعات:** 4 ركعات (بتسليمة واحدة أو تسليمتين)

**التسبيح الخاص:**
"سبحان الله والحمد لله ولا إله إلا الله والله أكبر"
يُكرر 300 مرة في الصلاة.

**كيفية الصلاة:**

**في كل ركعة (75 مرة):**

1. **بعد الفاتحة والسورة (قائماً):** 15 مرة
2. **في الركوع:** 10 مرات
3. **بعد الرفع من الركوع (قائماً):** 10 مرات
4. **في السجدة الأولى:** 10 مرات
5. **بين السجدتين (جالساً):** 10 مرات
6. **في السجدة الثانية:** 10 مرات
7. **بعد السجدة الثانية (قبل القيام):** 10 مرات

**المجموع:** 75 مرة في كل ركعة × 4 ركعات = 300 مرة

**الترتيب الكامل:**

**الركعة الأولى:**
1. النية وتكبيرة الإحرام
2. دعاء الاستفتاح (الثناء)
3. التعوذ والبسملة
4. الفاتحة وسورة
5. التسبيح 15 مرة
6. الركوع والتسبيح 10 مرات
7. القيام من الركوع والتسبيح 10 مرات
8. السجود والتسبيح 10 مرات
9. الجلوس بين السجدتين والتسبيح 10 مرات
10. السجود الثاني والتسبيح 10 مرات
11. الجلوس قبل القيام والتسبيح 10 مرات

**الركعة الثانية والثالثة والرابعة:**
نفس الطريقة بدون دعاء الاستفتاح.

**في الركعة الثانية:** اجلس للتشهد الأول (قراءة التحيات فقط)
**في الركعة الرابعة:** التشهد الكامل مع الصلاة الإبراهيمية والدعاء

**الفضائل:**
• قال النبي ﷺ لعمه العباس: "يا عباس، يا عماه، ألا أعطيك، ألا أمنحك، ألا أحبوك، ألا أفعل بك عشر خصال..."
• تغفر الذنوب وإن كانت مثل زبد البحر
• تصلى مرة في العمر، أو مرة في السنة، أو مرة في الشهر، أو مرة في الأسبوع، أو مرة في اليوم
• صلاة عظيمة الأجر

**ملاحظات:**
• يمكن صلاتها بتسليمة واحدة (4 ركعات متصلة)
• أو بتسليمتين (2+2)
• إذا نسيت العدد، أكمل بالتقدير الأقل
• الأفضل في جوف الليل
• تصلى فرادى (منفرداً)

**نصيحة:**
احرص على صلاتها ولو مرة في السنة، فهي صلاة عظيمة الفضل، أوصى بها النبي ﷺ أقرب الناس إليه.''',
      },
    },
    {
      'titleKey': 'namaz_guide_14_kusoof_prayer_solar_eclipse',
      'title': 'Kusoof Prayer (Solar Eclipse)',
      'titleUrdu': 'نماز کسوف (سورج گرہن)',
      'titleHindi': 'कुसूफ़ की नमाज़ (सूरज ग्रहण)',
      'titleArabic': 'صلاة الكسوف',
      'rakats': '2 Rakats (special method)',
      'rakatsUrdu': '۲ رکعت (خاص طریقہ)',
      'rakatsHindi': '2 रकात (ख़ास तरीक़ा)',

      'rakatsArabic': '2 रकात (ख़ास तरीक़ा)',
...
• अज़ाब से पनाह मांगें''',
        'arabic': '''**صلاة الكسوف (كسوف الشمس)**

**الوقت:** من بداية كسوف الشمس حتى انتهائه.

**الحكم:** سنة مؤكدة

**الركعات:** ركعتان بطريقة خاصة
...
1. تكبيرة الإحرام
2. دعاء الاستفتاح
3. قراءة الفاتحة وسورة طويلة (كسورة البقرة)
4. الركوع الأول - طويل
5. الرفع من الركوع والقيام
6. قراءة الفاتحة وسورة طويلة (أقصر من الأولى)
7. الركوع الثاني - طويل (أقصر من الأول)
8. الرفع من الركوع
9. السجود الأول - طويل
10. الجلوس بين السجدتين
11. السجود الثاني - طويل

**الركعة الثانية:**
نفس الطريقة (بركوعين وسجودين طويلين) لكن أقصر من الأولى.

**بعد الصلاة:**
1. التسليم
2. خطبة الإمام (وعظ وتذكير)
3. الدعاء والاستغفار حتى ينجلي الكسوف
4. الصدقة والعتق
...
**الفضائل والحكمة:**
• الكسوف والخسوف آيتان من آيات الله
• قال النبي ﷺ: "إن الشمس والقمر آيتان من آيات الله، لا ينكسفان لموت أحد ولا لحياته، فإذا رأيتم ذلك فافزعوا إلى الصلاة"
...
• لا أذان ولا إقامة
• ينادى "الصلاة جامعة"
• تصلى في جماعة في المسجد
• الإمام يطيل القراءة والركوع والسجود
• استمر في الدعاء والذكر حتى ينجلي الكسوف
• لا تنظر إلى الشمس مباشرة أثناء الكسوف

**دعاء الكسوف:**
أكثر من قول: "اللهم إني أعوذ بك من عذاب القبر، وأعوذ بك من عذاب النار، وأعوذ بك من فتنة المحيا والممات، وأعوذ بك من فتنة المسيح الدجال"''',
      },
    },
    {
      'titleKey': 'namaz_guide_15_khusoof_prayer_lunar_eclipse',
      'title': 'Khusoof Prayer (Lunar Eclipse)',
      'titleUrdu': 'نماز خسوف (چاند گرہن)',
      'titleHindi': 'ख़ुसूफ़ की नमाज़ (चांद ग्रहण)',
      'titleArabic': 'صلاة الخسوف',
      'rakats': '2 Rakats',
      'rakatsUrdu': '۲ رکعت',
      'rakatsHindi': '2 रकात',
...
**नोट:** कुछ उलमा कहते हैं चांद ग्रहण के लिए घर पर अकेले नमाज़ ठीक है, जबकि सूरज ग्रहण की नमाज़ मस्जिद में जमाअत से बेहतर है।''',
        'arabic': '''**صلاة الخسوف (خسوف القمر)**

**الوقت:** من بداية خسوف القمر حتى انتهائه (ليلاً).

**الحكم:** سنة مؤكدة

**الركعات:** ركعتان بنفس طريقة صلاة الكسوف (بركوعين في كل ركعة)

**كيفية الصلاة:**

نفس طريقة صلاة الكسوف تماماً:

**الركعة الأولى:**
1. تكبيرة الإحرام ودعاء الاستفتاح
2. قراءة الفاتحة وسورة طويلة
3. الركوع الأول طويل
4. القيام وقراءة الفاتحة وسورة (أقصر من الأولى)
5. الركوع الثاني طويل (أقصر من الأول)
6. الرفع ثم السجدتان الطويلتان

**الركعة الثانية:**
نفس الطريقة لكن أقصر من الأولى.

**الفرق بين الكسوف والخسوف:**
• **الكسوف:** كسوف الشمس (نهاراً)
• **الخسوف:** خسوف القمر (ليلاً)
• الصلاة بنفس الطريقة لكلاهما
...
**بعد الصلاة:**
• يستمر في الذكر والدعاء
• الصدقة والاستغفار
• الصلاة النافلة
• استمر حتى ينجلي الخسوف

**الحكمة:**
• تخويف من الله لعباده
• تذكير بعظمة الله وقدرته
• تذكير بيوم القيامة
...
और: "मुत्तिरना बिफ़ज़्लिल्लाहि व रहमतिहि" (हमें अल्लाह के फ़ज़ल और रहमत से बारिश मिली)''',
        'arabic': '''**صلاة الاستسقاء (طلب المطر)**

**الوقت:** عند الحاجة إلى المطر، في أي وقت تجوز فيه النافلة (يفضل بعد ارتفاع الشمس).

**الحكم:** سنة مؤكدة

**الركعات:** ركعتان مثل صلاة العيد

**الإعداد قبل الصلاة:**
• الصيام قبل الخروج (3 أيام مستحب)
• التوبة والرجوع إلى الله
• رد المظالم
• الإكثار من الصدقة
• الخروج متذللاً متواضعاً

**كيفية الصلاة:**

**مثل صلاة العيد:**
1. ركعتان بتكبيرات زائدة (مذهب الحنفية: مثل العيد)
2. أو ركعتان عاديتان مع إطالة القراءة (مذاهب أخرى)
3. يجهر الإمام بالقراءة
4. يقرأ سوراً تتضمن الاستغفار والتضرع

**السور الموصى بها:**
• سورة الأعلى في الركعة الأولى
• سورة الغاشية في الركعة الثانية
• أو سورة ق والقمر
• أو أي سور فيها التسبيح والتضرع

**بعد الصلاة:**
1. الخطبة (خطبتان كالجمعة)
2. استقبال القبلة
3. قلب الرداء (اليمين على اليسار واليسار على اليمين)
4. رفع اليدين والدعاء
...
"اللهم أنت الله لا إله إلا أنت، أنت الغني ونحن الفقراء، أنزل علينا الغيث، واجعل ما أنزلت لنا قوة وبلاغاً إلى حين"

**صفة الخروج:**
• الخروج بتواضع وتذلل وخشوع
• لبس ثياب بسيطة (ليست جديدة فاخرة)
• الخروج مشياً لا ركوباً (إن أمكن)
• مع النساء والشيوخ والأطفال
• يمكن إخراج البهائم
• الإكثار من الاستغفار في الطريق

**الحكمة:**
• التضرع إلى الله
• إظهار الافتقار إليه
• الاعتراف بأن المطر من الله وحده
• التوبة الجماعية

**ملاحظات:**
• لا أذان ولا إقامة
• تصلى في المصلى (خارج المدينة) أو في الصحراء
• يمكن تكرارها حتى ينزل المطر
• الدعاء في الخطبة أهم ركن
• قلب الرداء تفاؤلاً بتحول الحال

**بعد نزول المطر:**
قل: "مطرنا بفضل الله ورحمته"
"اللهم صيباً نافعاً"

ولا تقل: "مطرنا بنوء كذا" (أي بسبب النجم الفلاني)''',
      },
    },
    {
      'titleKey': 'namaz_guide_17_hajat_prayer_need',
...
• बारिश के दौरान
• फ़र्ज़ नमाज़ के बाद''',
        'arabic': '''**صلاة الحاجة (لقضاء الحوائج)**

**الوقت:** في أي وقت تجوز فيه النافلة.
...
**الحكم:** سنة عند الحاجة

**الركعات:** ركعتان أو أكثر (حتى 12 ركعة)

**كيفية الصلاة:**

**الإعداد:**
1. الوضوء الكامل بإتقان
2. اختيار مكان هادئ
3. استحضار عظمة الله
4. اليقين بالإجابة

**الصلاة:**
1. النية لصلاة الحاجة
2. صلاة ركعتين (أو أكثر) بخشوع
3. إطالة القراءة والركوع والسجود
4. التدبر في القراءة

**بعد الصلاة:**
1. حمد الله والثناء عليه
2. الصلاة على النبي ﷺ
3. رفع اليدين والدعاء بالحاجة
4. الإلحاح في الدعاء
...
**أو:**
"اللهم إني أسألك وأتوجه إليك بنبيك محمد ﷺ نبي الرحمة، يا محمد إني أتوجه بك إلى ربي في حاجتي هذه لتقضى، اللهم فشفعه في"

**الدعاء بالحاجة:**
ثم اذكر حاجتك بوضوح وإلحاح، مع اليقين بالإجابة.
...
• عدم الاستعجال
• الإلحاح في الدعاء
• الثناء على الله أولاً
• الصلاة على النبي ﷺ
• ذكر الحاجة بتفصيل
• حسن الظن بالله

**الأسباب المعينة على الإجابة:**
• طيب المأكل والمشرب
• رد المظالم
• حل الديون أو النية في سدادها
• الصدقة قبل الدعاء
• الإكثار من الاستغفار
• الصلاة على النبي ﷺ كثيراً

**الفضائل:**
• الله يحب الملحين في الدعاء
• ما من مسلم يدعو بدعوة ليس فيها إثم ولا قطيعة رحم إلا أعطاه الله بها إحدى ثلاث: إما أن يعجل له دعوته، أو يدخرها له في الآخرة، أو يصرف عنه من السوء مثلها

**ملاحظات:**
• يمكن تكرارها حتى تقضى الحاجة
• الأفضل في السحر (قبل الفجر)
• كلما كانت أصعب كان الأجر أعظم
• استمر على الدعاء ولا تيأس
• قد يؤخر الله الإجابة لحكمة
• ثق بالله فهو أعلم بما ينفعك

**نصيحة:**
اجمع بين صلاة الحاجة والصدقة والاستغفار وصلة الرحم، فهذه من أعظم أسباب إجابة الدعاء. وتذكر أن الله يحب العبد الملح في الدعاء، فلا تمل من السؤال.''',
      },
    },
    {
      'titleKey': 'namaz_guide_18_istikhara_prayer',
...
**الوقت:** عند الحيرة في أمر من أمور الدنيا المباحة، في أي وقت تجوز فيه النافلة.
...
**متى تصلى:**
عند الحيرة في أمر مباح، مثل:
• الزواج (اختيار الشريك)
• العمل (قبول وظيفة)
• الدراسة (اختيار تخصص)
• السفر
• البيع والشراء
• أي قرار مهم في الحياة

**لا تصلى في:**
• الأمور الواجبة (لا تستخير في صلاة الفجر!)
• الأمور المحرمة
• الأمور الواضحة
...
1. الوضوء بإتقان
2. اختيار وقت هادئ
3. صفاء الذهن من الهوى
4. الرضا بقضاء الله مسبقاً

**الصلاة:**
1. النية لصلاة الاستخارة
2. صلاة ركعتين بخشوع
3. يستحب قراءة سورة الكافرون في الركعة الأولى
4. وسورة الإخلاص في الركعة الثانية

**بعد التسليم:**
1. حمد الله والثناء عليه
2. الصلاة على النبي ﷺ
3. قراءة دعاء الاستخارة

**دعاء الاستخارة:**

"اللهم إني أستخيرك بعلمك، وأستقدرك بقدرتك، وأسألك من فضلك العظيم، فإنك تقدر ولا أقدر، وتعلم ولا أعلم، وأنت علام الغيوب.

اللهم إن كنت تعلم أن هذا الأمر [اذكر حاجتك هنا] خير لي في ديني ومعاشي وعاقبة أمري (أو: عاجل أمري وآجله)، فاقدره لي ويسره لي ثم بارك لي فيه.

وإن كنت تعلم أن هذا الأمر [اذكر حاجتك هنا] شر لي في ديني ومعاشي وعاقبة أمري (أو: عاجل أمري وآجله)، فاصرفه عني واصرفني عنه، واقدر لي الخير حيث كان ثم أرضني به"

**ثم الصلاة على النبي ﷺ مرة أخرى**

**ملاحظات مهمة:**

**علامة الاستخارة:**
ليست بالضرورة رؤيا في المنام!
• قد تكون انشراح صدر للأمر أو نفور منه
• قد تكون تيسير الأمور أو تعسرها
• قد تكون رؤيا (لكن ليست شرطاً)
• المهم: الرضا بما يقدره الله

**بعد الاستخارة:**
1. توكل على الله
2. ابدأ في الأمر
3. لا تنتظر علامات خارقة
4. ما تيسر فهو خير لك
5. ارض بقضاء الله

**يمكن تكرارها:**
إذا بقيت الحيرة، كرر الاستخارة (حتى 7 مرات)

**أخطاء شائعة:**
• انتظار رؤيا في المنام (ليس شرطاً)
• الاستخارة في أمور واضحة
• عدم الأخذ بالأسباب بعد الاستخارة
• عدم الرضا بالنتيجة

**آداب الاستخارة:**
• الإخلاص لله
• صفاء الذهن من الهوى
• الرضا المسبق بما يختاره الله
• عدم التعجل في النتيجة
• الأخذ بالأسباب بعدها
• الثقة بحكمة الله
...
**نصيحة:**
بعد الاستخارة، توكل على الله وامض في الأمر. ما تيسر فهو الخير لك، وما تعسر فاحمد الله فقد صرف عنك شراً. والله أعلم بما ينفعك في دينك ودنياك وآخرتك.
...
"ما خاب من استخار، ولا ندم من استشار، ولا عال من اقتصد"''',
  ...
  List<Map<String, dynamic>> get filteredNamazCategories {
    if (_searchQuery.isEmpty) {
      return _namazCategories;
    }
    final query = _searchQuery.toLowerCase();
    return _namazCategories.where((namaz) {
      final title = context
          .tr(namaz['titleKey'] ?? 'namaz_guide_1_takbeer_e_tahreema')
          .toString()
          .toLowerCase();
      String rakats;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(context.tr('sabhi_namaz')),
      ),
      body: Column(
        children: [
          // Search Bar
          ...
          // Prayer List
          Expanded(
            child: filteredNamazCategories.isEmpty
                ? Center(
                    child: Column(
  ...
  Widget _buildNamazCard(
    ...
    final title = context.tr(
      namaz['titleKey'] ?? 'namaz_guide_1_takbeer_e_tahreema',
    );
